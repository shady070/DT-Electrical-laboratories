...
const PreviousWork = () => {
  return (
    <div className="pt-[16px] px-[22px] lg:px-[72px] lg:py-[45px] bg-prev bg-no-repeat bg-cover">
      ...
      <div className="flex items-center justify-center py-[10px] lg:py-[30px]">
        <Link href="https://wa.me/27731128948" target="_blank" rel="noopener noreferrer">
          <button className="w-[87px] h-[35px] lg:w-[122px] lg:h-[50px] lg:text-[16px] bg-green rounded-full text-[12px]">Let&apos;s Talk</button>
        </Link> 
      </div>
    </div>
  )
